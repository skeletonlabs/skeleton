...
export type { FileUploadHiddenInputProps } from './anatomy/file-upload-hidden-input.js';
...
export type { FileUploadItemSizeTextProps } from './anatomy/file-upload-item-size-text.js';
