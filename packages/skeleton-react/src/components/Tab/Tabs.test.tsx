...
describe("<Tabs.Control>", () => {
    ...
    it("should allow for children", () => {
        const value = "children value";
        const { getByTestId } = render(<Tabs.Control name="test" group="test">{value}</Tabs.Control>);
...
describe("<Tabs.Panel>", () => {
    it("should render the component", () => {
        const { getByRole } = render(<Tabs.Panel value="test" group="test">content</Tabs.Panel>);
    ...
    it("should set `id` to `id` value", () => {
        const id = "test id";
        const { getByRole } = render(<Tabs.Panel value="test" group="test" id={id}>content</Tabs.Panel>);
    ...
    it("should set `aria-labelledby` to `labelledby` value", () => {
        ...
        const { getByRole } = render(<Tabs.Panel value="test" group="test" labelledBy={labelledBy}>content</Tabs.Panel>);
        expect(getByRole("tabpanel")).toHaveAttribute('aria-labelledby', labelledBy);
    });

    it("should allow for children", () => {
        const value = "children value";
        const { getByRole } = render(<Tabs.Panel value="test" group="test">{value}</Tabs.Panel>);
        expect(getByRole("tabpanel").innerHTML).toContain(value);
    });

    it("should allow you to set the `classes` style prop", () => {
        const tailwindClasses = "bg-blue-600";
        const { getByRole } = render(<Tabs.Panel value="test" group="test" classes={tailwindClasses} >content</Tabs.Panel>);
