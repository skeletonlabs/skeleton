...
export interface FloatingPanelBodyProps extends ComponentPropsWithoutRef<'div'> {
	element?: ElementType;
}
...
export default function Body(props: FloatingPanelBodyProps) {
	...
	if (!floatingPanel) throw new Error('FloatingPanel.Body must be used within FloatingPanel.Root');
