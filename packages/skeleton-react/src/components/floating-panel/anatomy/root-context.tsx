...
import { FloatingPanelRootContext as RootContext_ } from '../modules/root-context.js';
...
export default function FloatingPanelRootContext(props: FloatingPanelRootContextProps) {
