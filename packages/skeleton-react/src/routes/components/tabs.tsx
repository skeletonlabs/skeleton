...
import { Tabs, TabsList, TabsControl } from "../../components/Tab/Tabs";
    ...
    return (
        <>
            <section className="space-y-4">
                ...
                <Tabs>
                    <Tabs.List>
                        <TabsList.Control name="flight" group={group} onchange={setGroup} classes="w-full">
                                <TabsControl.Item>
                                    Flight
                                </TabsControl.Item>
                        </TabsList.Control>
                        <TabsList.Control name="hotel" group={group} onchange={setGroup} classes="w-full">
                            <TabsControl.Item>
                                Hotel
                            </TabsControl.Item>
                        </TabsList.Control>
                        <TabsList.Control name="explore" group={group} onchange={setGroup} classes="w-full">
                            <TabsControl.Item>
                                Explore
                            </TabsControl.Item>
                        </TabsList.Control>
            ...
            <section className="space-y-4">
                ...
                <Tabs>
                    <Tabs.List justify="justify-center">
                        <TabsList.Control name="flight" group={group} onchange={setGroup}>
                                <TabsControl.Item>
                                    Flight
                                </TabsControl.Item>
                        </TabsList.Control>
                        <TabsList.Control name="hotel" group={group} onchange={setGroup}>
                            <TabsControl.Item>
                                Hotel
                            </TabsControl.Item>
                        </TabsList.Control>
                        <TabsList.Control name="explore" group={group} onchange={setGroup}>
                            <TabsControl.Item>
                                Explore
                            </TabsControl.Item>
                        </TabsList.Control>
        ...
        <>
            <section className="space-y-4">
                ...
                <Tabs>
                    ...
                    <Tabs.Panel group={group} value="flight">
                        <button type="button" className="btn preset-filled">Book a Flight</button>
                    </Tabs.Panel>
                    <Tabs.Panel group={group} value="hotel">
                        <button type="button" className="btn preset-filled">See Hotels near you</button>
                    </Tabs.Panel>
                    <Tabs.Panel group={group} value="explore">
                        <button type="button" className="btn preset-filled">Explore</button>
                    </Tabs.Panel>
                </Tabs>
            </section>
        </>
            ...
            <section className="space-y-4">
                ...
                <div dir="rtl">
                    <Tabs>
                        ...
                        <Tabs.Panel group={group} value="flight">
                            Flight Panel                    </Tabs.Panel>
                        <Tabs.Panel group={group} value="hotel">
                            Hotel Panel                    </Tabs.Panel>
                        <Tabs.Panel group={group} value="explore">
                            Explore Panel
                        </Tabs.Panel>
                    </Tabs>
