...
export const classesFloatingPanel = defineSkeletonClasses({
	...
	resizeTrigger: [
		'data-[axis=n]:h-2 data-[axis=n]:w-[calc(100%-calc(var(--spacing)*2))]',
		'data-[axis=s]:h-2 data-[axis=s]:w-[calc(100%-calc(var(--spacing)*2))]',
		'data-[axis=e]:w-2 data-[axis=e]:h-[calc(100%-calc(var(--spacing)*2))]',
		'data-[axis=w]:w-2 data-[axis=w]:h-[calc(100%-calc(var(--spacing)*2))]',
		'data-[axis=ne]:size-2',
		'data-[axis=nw]:size-2',
		'data-[axis=se]:size-2',
		'data-[axis=sw]:size-2',
