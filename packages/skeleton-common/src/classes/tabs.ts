...
export const classesTabs = defineSkeletonClasses({
	...
	trigger:
		'btn hover:preset-tonal-primary data-[orientation=horizontal]:pb-2 data-[orientation=vertical]:pe-2 data-disabled:opacity-50 data-disabled:pointer-events-none',
	indicator:
