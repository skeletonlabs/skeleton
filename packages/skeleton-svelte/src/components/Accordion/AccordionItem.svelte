...
>
  ...
  <svelte:element this={`h${headingLevel}`}>
    ...
    >
      <!-- Lead -->
      {#if lead}
        <div class="{leadBase} {leadClasses}" data-testid="accordion-lead">
          {@render lead()}
        </div>
      {/if}
      <!-- Content -->
      <div
        class="{contentBase} {contentClasses}"
        data-testid="accordion-control"
      >
        {@render control()}
      </div>
      <!-- Indicator -->
      <div
        class="{indicatorBase} {indicatorClasses}"
