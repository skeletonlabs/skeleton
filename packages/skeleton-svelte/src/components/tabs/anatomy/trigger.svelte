<script lang="ts" module>
	...
	export interface TabsTriggerProps extends TriggerProps, PropsWithElement, Omit<HTMLAttributes<'button'>, 'value' | 'disabled'> {}
</script>
...
<script lang="ts">
	...
	const attributes = $derived(mergeProps(rootContext.api.getTriggerProps(triggerProps), { class: classesTabs.trigger }, rest));
</script>
