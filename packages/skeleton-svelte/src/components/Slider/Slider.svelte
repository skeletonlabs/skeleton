...
const rxReadOnly = $derived(
	service.prop("readOnly") ? stateReadOnly : thumbCursor,
);
</script>

<div
  {...api.getRootProps()}
  class="{base} {height} {spaceY} {rxDisabled} {classes}"
  data-testid="slider"
>
  <!-- Control -->
  <div
  ...
  >
    ...
    <div
      class={height}
      style="display: flex; align-items: center; transform: translateY(-100%);"
