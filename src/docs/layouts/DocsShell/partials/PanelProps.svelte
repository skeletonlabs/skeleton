	...
	{#if pageData.restProps}
		<aside class="alert variant-ghost-warning">
			...
			<div class="alert-message">
				<p>This component implements <a href="https://svelte.dev/docs#template-syntax-attributes-and-props" target="_blank" rel="noreferrer">restProps</a>. This passes all extra attributes to the component's <code class="code">{pageData.restProps}</code> elements.</p>
			</div>
		</aside>
	{/if}
	<!-- Tables -->
