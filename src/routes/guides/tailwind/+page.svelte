...
<div class="space-y-8">
	...
	<header class="space-y-4">
		...
		<p>
			Skeleton is fully compatible with <a href="https://tailwindcss.com/" target="_blank">Tailwind</a>, but requires a couple of extra steps to ensure everything works.
		</p>
	</header>
