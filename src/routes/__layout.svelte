<script lang="ts">
	...
	import { themeController } from "$lib/stores"
	...
	const navigation: any = [
        ...
        },
        {
            ...
            list: [
				...
				{href: '/utilities/themeswitcher', label: 'ThemeSwitcher'},
...
<svelte:head>
	...
	<meta name="color-scheme" content="{$themeController}" />
	<link rel="stylesheet" href={`/themes/theme-${$themeController.toLowerCase()}.css`} /> 
</svelte:head>
		...
		<svelte:fragment slot="header">
			<div class="flex justify-between items-center p-4">
				...
				<nav class="flex justify-between items-center space-x-6">
					...
					<!-- Theme Switch -->
					<ThemeSwitcher origin="tr" variants={presets} />
				</nav>
			</div>
			<Divider />
		</svelte:fragment>
