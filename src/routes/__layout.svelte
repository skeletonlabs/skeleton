...
<div class="flex flex-row">
    ...
    <!-- NavBar -->
    <div class="flex-none w-[300px] border-r-2 border-surface-200 py-8 space-y-8 bg-surface-50/75 dark:bg-surface-900/75 h-screen overflow-auto dark:border-surface-800">
    ...
    <!-- Page -->
    <div id="page" class="flex-1 container mx-auto basis-3/4 p-8 h-screen overflow-auto">
        <slot />
    </div>
