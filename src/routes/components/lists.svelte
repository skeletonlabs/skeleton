...
<script lang="ts">
    ...
    let items = [
        {label: 'Item A', icon: '', href: ''},
        {label: 'Item B', icon: '', href: ''},
        {label: 'Item C', icon: '', href: ''},
        {label: 'Item D', icon: '', href: ''},
    ]
...
<section class="space-y-4">
    <h4 class='space-y-4'>Basic</h4>
    <Card>
        <div class='w-1/2'>
            <ListGroup listItems={items} />
        </div>
    </Card>

    <h4 class='space-y-4'>Divided</h4>
    <Card>
        <div class='w-1/2'>
            <ListGroup listItems={items} divided />
        </div>
    </Card>

    <h4 class='space-y-4'>Hover (Interactive)</h4>
    <Card>
        <div class='w-1/2'>
            <ListGroup listItems={items} active />
        </div>
    </Card>

    <h4 class='space-y-4'>Size Comfortable</h4>
    <Card>
        <div class='w-1/2'>
            <ListGroup size='comfortable' listItems={items} active />
        </div>
    </Card>

    <h4 class='space-y-4'>Icon</h4>
    <Card>
        <div class='w-1/2'>
            <ListGroup size='comfortable' listItems={iconItems} active />
        </div>
    </Card>
</section>
