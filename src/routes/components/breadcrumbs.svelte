<script lang="ts">
    ...
    const tableProps: any = {
        ...
        data: [
            ['display', 'string', 'filled | outlined | text', 'text', 'Controls how the crumbs display.'],
            ['color', 'string', 'primary | accent | warning', '-', 'Controls the crumb color.'],
            ['seperator', 'string', '(html)', '>', 'Defines seperator. Works best with SVG.']
        ],
    };
    const tablePropsCrumb: any = {
        ...
        data: [
            ...
            ['disabled', 'boolean ', 'true | false', 'false', 'Defines the last element, the active page.'],
        ],
    };
</script>
...
<div class="space-y-8">
    ...
    <section class="space-y-4">
        <h2>Usage</h2>
        <CodeBlock language="javascript" code={`<script>import Breadcrumb from '@brainandbones/skeleton';</\script>`}></CodeBlock>
