...
<!-- NOTE: Keep Filter SVG Components localized -->
<Apollo />
<BlueNight />
<Emerald />
<GreenFall />
...
<DocsShell {settings}>
	...
	<svelte:fragment slot="usage">
		...
		<section class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:space-x-4">
			...
			<a class="btn variant-filled-secondary" href="https://fecolormatrix.com/" target="_blank" rel="noreferrer">Create Filter</a>
		</section>
		<hr />
		<section class="space-y-4">
