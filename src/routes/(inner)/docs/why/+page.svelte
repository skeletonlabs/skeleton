...
<div class="space-y-8">
	...
	<section class="space-y-4">
		...
		<p>
			Skeleton is available as <a href="https://github.com/Brain-Bones/skeleton" target="_blank">free and open-source software (FOSS)</a>
			provided under the
	...
	<section class="space-y-4">
		...
		<p>
			Skeleton is a brand new UI component library, featuring tight integration between <a href="https://svelte.dev/" target="_blank">Svelte</a>
			and <a href="https://tailwindcss.com/" target="_blank">Tailwind CSS</a>. In short, the library utilizes Tailwind’s utility class-based design system to quickly and easily customize and extend
			the look and feel of each component. Paired with Svelte’s powerful component architecture, Skeleton creates customized, responsive, and reactive interfaces for any size project.
		</p>
		<p>
	...
	<section class="space-y-4">
		...
		<p>
			Like many in the frontend development community, we have been impressed with the introduction of <a href="https://svelte.dev/" target="_blank">Svelte</a> - which provides a modern and powerful
			component system. We've also kept a eye on Rich Harris and his team's up-and-coming app framework, called <a href="https://kit.svelte.dev/" target="_blank">SvelteKit</a>, that provides a turnkey
			solution for building and iterating on web projects using Svelte and next generation tooling such as <a href="https://vitejs.dev/" target="_blank">Vite</a>. However, we’ve noted a lack of mature
			Svelte-focused UI component libraries. While there’s plenty of
			<a href="https://www.youtube.com/watch?v=RkD88ARvucM" target="_blank">options</a>, most tend to focus on Material Design guidelines and aesthetics. While a completely valid approach, we felt
			there was still room for a batteries included toolkit that pairs the very best of what Svelte and Tailwind have to offer. This is the reason we've introduced Skeleton.
		</p>
	</section>
</div>
