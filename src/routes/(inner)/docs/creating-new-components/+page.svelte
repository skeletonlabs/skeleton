...
$: classesCard = \`\${cBase} \${classesOutlined}\`;
	...
	<section class="space-y-4">
		...
		<h3>Update Site Navigation</h3>
		<p>
			Open <code>src/docs/DocsNavigation/links.ts</code> and document the new links under the appropriate section. In general, simple components go under
