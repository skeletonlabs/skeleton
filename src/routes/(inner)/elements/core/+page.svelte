		...
		<div class="space-y-4">
			...
			<Alert>
				...
				<svelte:fragment slot="trail">
					...
					<a class="btn btn-ghost" href="https://github.com/Brain-Bones/skeleton/blob/master/src/app.postcss" target="_blank" rel="noreferrer">Reference</a>
					<a class="btn btn-filled" href="https://csshero.org/mesher/" target="_blank" rel="noreferrer">Generate</a>
				</svelte:fragment>
			</Alert>
		</div>
		<!-- Scrollbars -->
