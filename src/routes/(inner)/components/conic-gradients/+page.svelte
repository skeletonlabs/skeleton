...
const dataSet: any[] = [
	...
	{ color: 'green', start: 50, end: 100 }
        ...
        `}
		/>
		<CodeBlock language="html" code={`<ConicGradient data={dataSet} legend={false} spin={false}>(caption)</ConicGradient>`} />
		<!-- Legend -->
		<h3>Legend</h3>
...
const dataSet: any[] = [
	...
	{ label: 'Hex', color: '#bada55', start: 35, end: 100 }
		...
		<CodeBlock language="html" code={`<ConicGradient data={dataSet} spin={true} width="w-8" />`} />
		<CodeBlock
			language="js"
			code={`
const dataSet: any[] = [
