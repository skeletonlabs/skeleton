...
<div class="flex flex-col lg:flex-row justify-center items-center gap-4 md:gap-10 place-items-center">
	...
	<div class="space-y-4 text-center lg:text-left">
		...
		<p class="max-w-[480px]">
			Skeleton is a community-owned project that survives through your support. Consider becoming a sponsor through these select services.
			For larger donations please <a href="maito:admin@skeleton.dev">contact us</a>.
		</p>
