<script lang="ts">
	...
	const tableProps: any = {
		...
		source: [
			['language', 'string', 'html | css | js | ...', 'plaintext', 'Sets a language alias: <a href="https://prismjs.com/#supported-languages" target="_blank">Prism.js</a>'],
			[
				'code',
				'string',
				'-',
			...
			['contenteditable', 'boolean', 'true | false', 'false', 'Specifies whether or not the Codeblock should be editable.']
		]
	};
</script>
...
<div class="space-y-8">
	...
	<header class="space-y-4">
		<h1>Code Blocks</h1>
		<p>
			Displays pre-formatted source code, with built-in support for <a href="https://prismjs.com//" target="_blank">Prism.js</a>.
		</p>
	...
	<Card class="space-y-4">
		...
		<CodeBlock language="html" contenteditable code={`<p>this code is editable</p>`} />
	</Card>
	...
	<section class="space-y-4">
		<h2>Usage</h2>
		<p>
			Please note that Skeleton will install <a href="https://prismjs.com//" target="_blank">Prism.js</a> as a dependency for this.
		</p>
		<h4>Add a Theme</h4>
		<p>
			Implement a <a href="https://github.com/PrismJS/prism/tree/master/themes" target="_blank">Prism.js CSS theme</a>. Add the following to your app's root component, before your theme and global
			stylesheet import.
		</p>
		<CodeBlock language="js" code={`import 'prismjs/themes/prism-okaidia.css';`} />
