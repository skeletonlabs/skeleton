...
<div>
	...
	<Alert>
		...
		<span>Skeleton is currently in beta status. Expect breaking changes prior to v1.0. Please report bugs on GitHub.</span>
	...
	<div class="container max-w-[1200px] mx-auto px-4 py-10 md:py-20 space-y-20">
		<!-- Hero -->
		<header class="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-10 place-items-center">
			<div class="space-y-6">
				<!-- Text -->
				...
				<h2 class="text-3xl md:text-4xl lg:text-5xl">A fully featured UI Toolkit.</h2>
				<p class="text-xl">
					Build fast and reactive web interfaces using <a href="https://svelte.dev/" target="_blank" rel="noreferrer">Svelte</a>
			...
			<!-- Logo (Big) -->
			<svg class="fill-token w-64 h-64 -scale-x-[100%] dark:drop-shadow-2xl" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
				<path
					fill-rule="evenodd"
		...
		<section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
			...
			<div class="card card-body !bg-surface-500/5 space-y-4">
		...
		<section class="text-center space-y-6">
			...
			<ul class="grid grid-cols-1 md:grid-cols-2 gap-4">
				<li class="card card-body !bg-surface-500/5 space-y-4">
						...
						{#each response as s}
							<li>
								<a href={s.profile} target="_blank" rel="noreferrer" title={s.handle}>
									<Avatar src={s.avatar} size="fluid" shadow="shadow-lg" hover class="m-2 max-w-[50px]" />
								</a>
							</li>
						{/each}
					</ul>
