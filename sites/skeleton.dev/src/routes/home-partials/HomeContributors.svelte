...
<div class="space-y-10">
  ...
  <div class="flex justify-center">
    ...
    <div class="card variant-soft-secondary overflow-hidden">
      <header class="variant-filled-secondary grid grid-cols-[1fr_auto_auto] items-center gap-4 p-4 md:p-8 md:py-8">
      ...
      <section class="grid grid-cols-1 gap-4 p-4 sm:grid-cols-2 md:p-10">
  ...
  <div class="space-y-4 text-center lg:text-left">
    <div class="mx-auto grid max-w-4xl grid-cols-8 gap-4 md:grid-cols-12">
