...
<div class="flex flex-col place-items-center items-center justify-center gap-4 md:gap-10 lg:flex-row">
  <!-- Premium Sponsors -->
  <div class="grid grid-cols-2 gap-4 md:gap-10">
    ...
    <div class="card variant-filled-primary whitespace-nowrap p-2 text-center text-xs shadow-xl" data-popup="popupBrainBones">
    ...
    <div class="card variant-filled-primary whitespace-nowrap p-2 text-center text-xs shadow-xl" data-popup="popupLukeHagar">
      <p class="font-bold">Premium Sponsor</p>
      <p>Luke Hagar</p>
      <!-- Arrow -->
      <div class="arrow variant-filled-primary" />
