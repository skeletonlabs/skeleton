    ...
    <DocsPreview label={showcase} regionPreview="min-h-[320px]">
      <svelte:fragment slot="preview">
        {#if showcase === 'components'}
          ...
          <Accordion autocollapse class="card text-token p-4">
            <AccordionItem open>
              <svelte:fragment slot="lead"><i class="fa-solid fa-skull w-6 text-center text-xl" /></svelte:fragment>
            ...
            <AccordionItem>
              <svelte:fragment slot="lead"><i class="fa-solid fa-clock w-6 text-center text-xl" /></svelte:fragment>
            ...
            <AccordionItem>
              <svelte:fragment slot="lead"><i class="fa-solid fa-calendar w-6 text-center text-xl" /></svelte:fragment>
            ...
            <AccordionItem>
              <svelte:fragment slot="lead"><i class="fa-solid fa-gift w-6 text-center text-xl" /></svelte:fragment>
            ...
            <AccordionItem>
              <svelte:fragment slot="lead"><i class="fa-solid fa-file w-6 text-center text-xl" /></svelte:fragment>
        ...
        {:else if showcase === 'actions'}
          <section class="grid grid-cols-2 gap-4 p-4 md:grid-cols-4">
