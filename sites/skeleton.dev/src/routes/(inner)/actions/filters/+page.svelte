...
<DocsShell {settings}>
	...
	<svelte:fragment slot="sandbox">
		<DocsPreview>
			<svelte:fragment slot="preview">
				<section class="grid grid-cols-2 gap-4 p-4 md:grid-cols-3 xl:grid-cols-5">
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} alt="example" />
						<span class="badge variant-soft">Original</span>
					</div>
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} use:filter={'#Emerald'} alt="example" />
						<span class="badge variant-soft">Emerald</span>
					</div>
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} use:filter={'#BlueNight'} alt="example" />
						<span class="badge variant-soft">BlueNight</span>
					</div>
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} use:filter={'#XPro'} alt="example" />
						<span class="badge variant-soft">XPro</span>
					</div>
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} use:filter={'#Summer84'} alt="example" />
						<span class="badge variant-soft">Summer84</span>
					</div>
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} use:filter={'#Rustic'} alt="example" />
						<span class="badge variant-soft">Rustic</span>
					</div>
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} use:filter={'#Apollo'} alt="example" />
						<span class="badge variant-soft">Apollo</span>
					</div>
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} use:filter={'#GreenFall'} alt="example" />
						<span class="badge variant-soft">GreenFall</span>
					</div>
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} use:filter={'#Noir'} alt="example" />
						<span class="badge variant-soft">Noir</span>
					</div>
					<div class="flex flex-col items-center space-y-4 overflow-hidden">
						<img class="rounded-container-token aspect-square w-full" src={imgPlaceholder} use:filter={'#NoirLight'} alt="example" />
	...
	<svelte:fragment slot="usage">
		...
		<section class="flex flex-col items-start justify-between space-y-4 md:flex-row md:items-center md:space-x-4 md:space-y-0">
			<div class="space-y-2">
		...
		<section class="space-y-4">
			...
			<div class="grid grid-cols-2 gap-4 text-center md:grid-cols-4">
				<div class="card !bg-green-500 p-2 text-black">
				...
				<div class="card !bg-yellow-500 p-2 text-black">
