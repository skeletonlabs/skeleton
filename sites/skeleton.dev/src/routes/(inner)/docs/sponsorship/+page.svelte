...
<LayoutPage>
  ...
  <section class="grid grid-cols-1 gap-4 lg:grid-cols-3">
    <a
      class="card card-hover flex flex-col items-center space-y-4 !bg-[#6e5494] p-4 md:py-10 lg:py-20"
    ...
    <a
      class="card card-hover flex flex-col items-center space-y-4 !bg-[#1AC0FF] p-4 md:py-10 lg:py-20"
    ...
    <a
      class="card card-hover flex flex-col items-center space-y-4 !bg-[#FF424D] p-4 md:py-10 lg:py-20"
  ...
  <section class="space-y-4">
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
      <!-- Template: Portfolio -->
      <a class="card hover:variant-filled-primary space-y-4 p-4" href="https://skeleton-template-portfolio.vercel.app/" target="_blank">
      ...
      <!-- Template: Blog -->
      <a class="card hover:variant-filled-primary space-y-4 p-4" href="https://skeleton-template-blog.vercel.app/" target="_blank">
    ...
    <Accordion autocollapse class="card variant-glass p-2">
      ...
      <AccordionItem>
        ...
        <svelte:fragment slot="content">
          ...
          <video
            class="rounded-container-token h-auto w-full overflow-hidden bg-black shadow-xl"
      ...
      <AccordionItem>
        ...
        <svelte:fragment slot="content">
          ...
          <div class="grid grid-cols-1 items-start gap-4 xl:grid-cols-3">
            <section class="card space-y-4 p-8">
