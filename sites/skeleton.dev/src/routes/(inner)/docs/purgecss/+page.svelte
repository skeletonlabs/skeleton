...
<LayoutPage>
	...
	<header class="space-y-4">
		...
		<div>
			<div class="!flex flex-col md:flex-row justify-between items-start space-y-4 md:space-y-0 md:space-x-4">
                <!-- prettier-ignore -->
				<p>
                    This guide covers <code class="code">vite-plugin-tailwind-purgecss</code>, a simple to use Vite plugin that thoroughly purges excess CSS via <a class="anchor" href="https://purgecss.com/" target="_blank">PurgeCSS</a>. While optional, this is highly recommended if you wish to minimize your production CSS bundle size.
                </p>
	...
	<section class="space-y-4">
		...
		<!-- prettier-ignore -->
		<p>
            Ideally, we would like to limit selectors to only those used within your project. We accomplish by analyzing the emitted Javascript chunks generated by Rollup, which includes only the modules that are actually used in your project, then extracts only the utilized selectors. From there, we can pass along the selectors to PurgeCSS for final processing.
        </p>
	</section>
