	...
	<svelte:fragment slot="usage">
		...
		<section class="space-y-4">
			...
			<DocsPreview background="neutral">
				<svelte:fragment slot="preview">
					<button class="btn variant-filled col-span-2" on:click={triggerMetadata}>Metadata Example</button>
				</svelte:fragment>
				<svelte:fragment slot="source">
					<CodeBlock
						language="ts"
...
`}
		...
		<section class="space-y-4">
			...
			<DocsPreview background="neutral">
				<svelte:fragment slot="preview">
					<button class="btn variant-filled col-span-2" on:click={triggerStyled}>Styled Drawer</button>
				</svelte:fragment>
				<svelte:fragment slot="source">
