	...
	<svelte:fragment slot="sandbox">
		<DocsPreview>
			...
			<svelte:fragment slot="source">
				<p>There are several steps involved in utilizing this feature. Please refer to the documented instructions below.</p>
			</svelte:fragment>
		</DocsPreview>
	</svelte:fragment>
...
`}
		...
		<section class="space-y-4">
			...
			<p>We recommend applying global styles via the Toast component props. However, you can provide styles per toast instance.</p>
