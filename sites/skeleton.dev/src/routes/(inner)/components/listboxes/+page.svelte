	...
	<svelte:fragment slot="sandbox">
		<DocsPreview>
			<svelte:fragment slot="preview">
				<div class="card text-token w-full max-w-[480px] p-4">
					<ListBox>
						<ListBoxItem bind:group={valueSingle} name="medium" value="books">
							<svelte:fragment slot="lead"><i class="fa-solid fa-book w-6 text-center text-xs" /></svelte:fragment>
							Books
						</ListBoxItem>
						<ListBoxItem bind:group={valueSingle} name="medium" value="movies">
							<svelte:fragment slot="lead"><i class="fa-solid fa-film w-6 text-center text-xs" /></svelte:fragment>
							Movies
						</ListBoxItem>
						<ListBoxItem bind:group={valueSingle} name="medium" value="television">
							<svelte:fragment slot="lead"><i class="fa-solid fa-tv w-6 text-center text-xs" /></svelte:fragment>
							Television
						</ListBoxItem>
					</ListBox>
				</div>
