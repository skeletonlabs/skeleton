        ...
        <svelte:fragment slot="preview">
          ...
          >
            <svelte:fragment slot="header">
              {#if state.header}
                <div class="card variant-soft m-0.5 flex items-center justify-center overflow-hidden p-2 text-xs">header</div>
              {/if}
            </svelte:fragment>
            <svelte:fragment slot="sidebarLeft">
              {#if state.sidebarLeft}
                <div class="card variant-soft m-0.5 flex items-center justify-center overflow-hidden p-2 text-xs">sidebarLeft</div>
              {/if}
            </svelte:fragment>
            <svelte:fragment slot="sidebarRight">
              {#if state.sidebarRight}
                <div class="card variant-soft m-0.5 flex items-center justify-center overflow-hidden p-2 text-xs">sidebarRight</div>
              {/if}
            </svelte:fragment>
            <svelte:fragment slot="pageHeader">
              {#if state.pageHeader}
                <div class="card variant-soft-primary m-0.5 flex items-center justify-center overflow-hidden p-2 text-xs">pageHeader</div>
              {/if}
            </svelte:fragment>
            <svelte:fragment slot="pageFooter">
              {#if state.pageFooter}
                <div class="card variant-soft-primary m-0.5 flex items-center justify-center overflow-hidden p-2 text-xs">pageFooter</div>
              {/if}
            </svelte:fragment>
            <!-- --- -->
            <div class="card variant-soft-primary m-0.5 flex items-center justify-center overflow-hidden p-2 text-xs">
              {'<slot />'}
            </div>
            <!-- --- -->
            <svelte:fragment slot="footer">
              {#if state.footer}
                <div class="card variant-soft m-0.5 flex items-center justify-center overflow-hidden p-2 text-xs">footer</div>
              {/if}
            </svelte:fragment>
          </AppShell>
        </svelte:fragment>
