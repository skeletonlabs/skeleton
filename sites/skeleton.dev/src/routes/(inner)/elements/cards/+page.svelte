	...
	<svelte:fragment slot="sandbox">
		<DocsPreview>
			<svelte:fragment slot="preview">
				<div class="text-token grid w-full grid-cols-1 gap-4 md:grid-cols-2">
					<!-- Minimal -->
					<div class="card {currentVariant} flex items-center justify-center p-4"><span>Minimal</span></div>
					<!-- Detailed -->
	...
	<footer class="card-footer">(footer)</footer>
		...
		<section class="space-y-4">
			...
			<DocsPreview background="neutral">
				<svelte:fragment slot="preview">
					<div class="text-token w-full">
						<a class="card card-hover block p-4 text-center" href="/elements/cards">Hover Me!</a>
					</div>
				</svelte:fragment>
				<svelte:fragment slot="source">
