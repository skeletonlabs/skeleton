  ...
  <svelte:fragment slot="sandbox">
    <DocsPreview>
      <svelte:fragment slot="preview">
        <section class="text-token card w-full space-y-4 p-4">
          ...
          <div class="text-token card w-full space-y-4 p-4">
            <ol class="list">
              {#each listData as v, i}
                <li>
                  <span class="badge-icon variant-soft-primary p-4">{i + 1}</span>
        ...
        <svelte:fragment slot="preview">
          <div class="text-token card w-full space-y-4 p-4">
            <dl class="list-dl">
              {#each listData as v}
                <div>
                  <span class="badge-icon variant-soft-secondary p-4"><i class="fa-solid fa-book" /></span>
                  <span class="flex-auto">
                ...
                {#each listData as v}
                  <li>
                    <a href="/elements/lists">
                      <span class="badge-icon variant-soft-tertiary p-4"><i class="fa-solid fa-arrow-right" /></span>
                      <span class="flex-auto">
                        Nav Item {v.label}
                      </span>
                      <span>⋮</span>
