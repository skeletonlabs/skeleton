	...
	<svelte:fragment slot="sandbox">
		<section class="card">
			<div class="chat grid h-full w-full grid-cols-1 lg:grid-cols-[30%_1fr]">
				<!-- Navigation -->
				<div class="border-surface-500/30 hidden grid-rows-[auto_1fr_auto] border-r lg:grid">
					<!-- Header -->
				...
				<div class="grid-row-[1fr_auto] grid">
					...
					<!-- Prompt -->
					<section class="border-surface-500/30 border-t p-4">
						<div class="input-group input-group-divider rounded-container-token grid-cols-[auto_1fr_auto]">
			...
			<DocsPreview background="neutral">
				<svelte:fragment slot="preview">
					<div class="w-full space-y-4">
						...
						<div class="grid w-full grid-cols-[auto_1fr] gap-1">
							<div class="bg-surface-500/30 p-4">(nav)</div>
							<div class="bg-surface-500/30 p-4">(feed)</div>
						</div>
					</div>
			...
			<DocsPreview background="neutral">
				<svelte:fragment slot="preview">
					<div class="grid w-full grid-cols-2 gap-10">
						<div class="grid h-[240px] grid-rows-[auto_1fr_auto] gap-1">
						...
						<div class="grid h-[240px] grid-rows-[1fr_auto] gap-1">
							<div class="bg-surface-500/30 space-y-4 overflow-y-auto p-4">
								<p>(feed)</p>
...
<div class="h-full grid grid-rows-[1fr_auto] gap-1">
	...
	<div class="bg-surface-500/30 p-4">(prompt)</div>
		...
		<section class="space-y-4">
			...
			<DocsPreview background="neutral">
				<svelte:fragment slot="preview">
					<section class="max-h-[400px] w-full space-y-4 overflow-y-auto p-4">
	...
	{/each}
		...
		<section class="space-y-4">
			...
			<DocsPreview background="neutral">
				<svelte:fragment slot="preview">
					<!-- Conversation -->
					<section class="max-h-[500px] space-y-4 overflow-y-auto p-4">
						{#each messageFeed.slice(0, 2) as bubble}
							{#if bubble.host === true}
								<div class="grid grid-cols-[auto_1fr] gap-2">
									<Avatar src="https://i.pravatar.cc/?img={bubble.avatar}" width="w-12" />
