				...
				<Portal>
					...
					<Dialog.Positioner className="fixed inset-0 z-50 flex justify-start">
						<Dialog.Content className="h-screen card bg-surface-100-900 w-sm p-4 space-y-4 shadow-xl data-[state=open]:animate-[slide-out_100ms_ease-in-out]">
							...
							<p>
								Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nulla, soluta optio assumenda nobis dignissimos minus doloremque
								in aliquid amet laboriosam! Soluta recusandae facilis provident ratione a! Vitae expedita rerum magni.
							</p>
						</Dialog.Content>
					</Dialog.Positioner>
				</Portal>
