...
<div class="docs-themer space-y-4">
	<div class="card variant-glass flex items-center justify-between p-4">
	...
	<div class="grid grid-cols-2 gap-4">
		...
		<section class="card col-span-2">
			<!-- General Settings -->
			<header class="col-span-2 flex items-center justify-between p-4">
			...
			<div class="grid grid-cols-1 gap-4 p-4">
				{#each $storeThemGenForm.colors as colorRow, i}
					<div class="grid grid-cols-1 gap-2 lg:grid-cols-[170px_1fr_200px] lg:gap-4">
						<label class="label">
							<span>{colorRow.label}</span>
							<div class="grid grid-cols-[auto_1fr] place-items-end gap-4">
						...
						<label>
							...
							<div class="flex">
								...
								<div
									data-popup={'popup-' + i}
									class="card variant-filled whitespace-nowrap p-2 text-xs"
		...
		<!-- Theme Settings -->
		<section class="card col-span-2 grid grid-cols-2 gap-4 p-4 lg:col-span-1">
			<!-- Fonts -->
		...
		<!-- Previews -->
		<section class="card variant-glass col-span-2 space-y-8 p-4 lg:col-span-1">
