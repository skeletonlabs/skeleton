...
<AppBar shadow="shadow-2xl" slotTrail="!space-x-2">
	...
	<svelte:fragment slot="trail">
		...
		<div>
			...
			<!-- popup -->
			<div class="card w-60 p-4 shadow-xl" data-popup="sponsor">
				<div class="space-y-4">
					<nav class="list-nav">
						<ul>
							<li>
		...
		<div class="relative hidden lg:block">
			...
			<!-- popup -->
			<div class="card w-60 p-4 shadow-xl" data-popup="version">
				<nav class="list-nav">
					<ul>
						<li>
		...
		<div class="md:ml-4 md:inline">
			<button class="btn variant-soft hover:variant-soft-primary space-x-4" on:click={triggerSearch}>
