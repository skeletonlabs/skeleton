...
| ------ | ---------------------------------------------------------------- | ---------------------------------------------- |
| `v3`   | Represents the release branch of the all v3 projects.            | <Check size={16} className='inline' /> Allowed |
| `main` | Represents the release branch of the all Next (aka v4) projects. | <Check size={16} className='inline' /> Allowed |
