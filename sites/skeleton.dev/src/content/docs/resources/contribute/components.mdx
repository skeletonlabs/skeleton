...
| ----------------- | ------------------------------------------ | ----------------------------- |
| `pnpm dev:docs`   | Runs the Documentation website dev server. | `skeleton`, `skeleton-common` |
| `pnpm dev:themes` | Runs the Themes website dev server.        | `skeleton`                    |
| `pnpm dev:react`  | Runs the React Playground dev server.      | `skeleton`, `skeleton-common` |
| `pnpm dev:svelte` | Runs the Svelte Playground dev server.     | `skeleton`, `skeleton-common` |
