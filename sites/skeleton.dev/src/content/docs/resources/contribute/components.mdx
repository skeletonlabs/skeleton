...
Make sure to generate the documentation for the new component by running `pnpm generate` in `/packages/docs`. This will generate the `json` that is consumed by the documentation website.
