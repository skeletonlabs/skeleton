...
| [Radix UI](https://www.radix-ui.com/) | (stable)           |
| [Tailwind](https://tailwindcss.com/)  | 4                  |

## Introduction

In this guide we'll implement the Radix UI `<ToggleGroup>` component. This will showcase the bare minimum requirements for integrating Skeleton with Radix UI. You are then responsible for all further components.
...
<Process>
    ...
    <ProcessStep step="3">
    	...
    	Create a new component in `/src/components/ToggleGroup/ToggleGroup.tsx` and insert the following markup. This will generate an unstyled version of the component.
