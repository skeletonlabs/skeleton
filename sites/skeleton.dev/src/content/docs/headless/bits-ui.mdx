...
import SnippetPage from '@examples/headless/bits-ui/ExamplePage.txt?raw';
import SnippetBoilerplate from '@examples/headless/bits-ui/ExampleBoilerplate.txt?raw';
import SnippetComplete from '@examples/headless/bits-ui/ExampleWhole.txt?raw';
...
<Code code={SnippetComplete} lang="svelte" />
