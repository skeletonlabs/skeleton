...
import ExamplePageRaw from '@examples/headless/bits-ui/ExamplePage.txt?raw';
import ExampleBoilerplateRaw from '@examples/headless/bits-ui/ExampleBoilerplate.txt?raw';
import ExampleWholeRaw from '@examples/headless/bits-ui/ExampleWhole.txt?raw';
