...
import Example from '@/components/examples/tailwind/tables/Example.astro';
import ExampleRaw from '@/components/examples/tailwind/tables/Example.astro?raw';
import ExampleFull from '@/components/examples/tailwind/tables/ExampleFull.astro';
import ExampleFullRaw from '@/components/examples/tailwind/tables/ExampleFull.astro?raw';
import ExampleNav from '@/components/examples/tailwind/tables/ExampleNav.astro';
