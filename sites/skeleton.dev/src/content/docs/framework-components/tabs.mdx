...
When using frameworks like SvelteKit and React Router, controlling the active tabs based on the URL can be useful.

To achieve this, you need to do two things:

- Set the `value` prop to the current URL path.
- Listen to the `navigate` event and update the URL path.
...
export default function Routing() {
 ...
 return (
  <Tabs value={pathname} navigate={(e) => navigate(e.href)}>
   <Tabs.List>
    <Tabs.Trigger
     value="/overview"
...
<Tabs value={page.url.pathname} navigate={(e) => goto(e.href)}>
	<Tabs.List>
	...
	<Tabs.Content value={page.url.pathname}>
		{@render children()}
	</Tabs.Content>
</Tabs>
```
