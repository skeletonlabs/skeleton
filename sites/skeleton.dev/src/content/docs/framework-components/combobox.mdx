...
import MultipleChipsReact from '@/components/examples/framework-components/combobox/react/multiple-chips';
import MultipleChipsReactRaw from '@/components/examples/framework-components/combobox/react/multiple-chips?raw';
...
import MultipleChipsSvelte from '@/components/examples/framework-components/combobox/svelte/multiple-chips.svelte';
import MultipleChipsSvelteRaw from '@/components/examples/framework-components/combobox/svelte/multiple-chips.svelte?raw';
...
Extend the multi-select pattern with removable chip elements. Each selected item is rendered as a chip with a dismiss button — clicking it deselects the item and syncs the controlled `value` back to the Combobox.

<Framework id="react">
	<Preview framework="react" files={{ 'app.tsx': MultipleChipsReactRaw }} client:visible>
		<MultipleChipsReact client:visible />
	</Preview>
</Framework>
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': MultipleChipsSvelteRaw }} client:visible>
		<MultipleChipsSvelte client:visible />
	</Preview>
</Framework>
