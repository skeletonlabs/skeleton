...
import UsageReact from '@/components/examples/framework-components/toast/svelte/usage.txt?raw';
import UsageSvelte from '@/components/examples/framework-components/toast/svelte/usage.txt?raw';
...
{/* prettier-ignore */}
<Framework id="react">
	{/* <Code code={UsageReact} lang="tsx" /> */}
	(code block here)
</Framework>
{/* prettier-ignore */}
<Framework id="svelte">
	{/* <Code code={UsageSvelte} lang="svelte" /> */}
	(code block here)
</Framework>
