...
import ProviderPatternSvelte from '@/components/examples/framework-components/popover/svelte/programmatic.svelte';
import ProviderPatternSvelteRaw from '@/components/examples/framework-components/popover/svelte/programmatic.svelte?raw';
