...
import AnchorReact from '@/components/examples/framework-components/popover/react/anchor';
import AnchorReactRaw from '@/components/examples/framework-components/popover/react/anchor?raw';
...
import AnchorSvelte from '@/components/examples/framework-components/popover/svelte/anchor.svelte';
import AnchorSvelteRaw from '@/components/examples/framework-components/popover/svelte/anchor.svelte?raw';
...
Use the `Anchor` component to position the popover relative to a different element than the trigger. This is useful when you want the popover to appear anchored to a specific element while still using a separate button or element as the trigger.

<Framework id="react">
	<Preview framework="react" files={{ 'app.tsx': AnchorReactRaw }} client:visible>
		<AnchorReact client:visible />
	</Preview>
</Framework>
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': AnchorSvelteRaw }} client:visible>
		<AnchorSvelte client:visible />
	</Preview>
</Framework>
