...
Unlike most components in Skeleton, this is provided "headless". Meaning no default styles are applied out of the box. This ensures you retain full control of all styling for maximum flexibility.
...
This example repurposes the Dialog for use as a side-panel Drawer. It pairs well with the [Navigation Sidebar](/docs/svelte/framework-components/navigation#sidebar).
