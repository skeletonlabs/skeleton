...
summary: Presets are pre-defined utility classes that allow you to quickly and easily style buttons, badges, cards, and more. They are implemented using a combination of Skeleton and Tailwind primitives. A number of presets are available out of the box, with guidelines provided for crafting your own.
references:
  source: 'https://github.com/skeletonlabs/skeleton/blob/main/packages/skeleton/src/utilities/presets.css'
---

import Preview from './src/components/ui/preview.svelte';
import Default from '@/components/examples/tailwind-utilities/presets/default.astro';
import DefaultRaw from '@/components/examples/tailwind-utilities/presets/default.astro?raw';
import Filled from '@/components/examples/tailwind-utilities/presets/filled.astro';
import FilledRaw from '@/components/examples/tailwind-utilities/presets/filled.astro?raw';
import Glass from '@/components/examples/tailwind-utilities/presets/glass.astro';
import GlassRaw from '@/components/examples/tailwind-utilities/presets/glass.astro?raw';
import Gradient from '@/components/examples/tailwind-utilities/presets/gradient.astro';
import GradientRaw from '@/components/examples/tailwind-utilities/presets/gradient.astro?raw';
import Inputs from '@/components/examples/tailwind-utilities/presets/inputs.astro';
import InputsRaw from '@/components/examples/tailwind-utilities/presets/inputs.astro?raw';
import Outlined from '@/components/examples/tailwind-utilities/presets/outlined.astro';
import OutlinedRaw from '@/components/examples/tailwind-utilities/presets/outlined.astro?raw';
import Tonal from '@/components/examples/tailwind-utilities/presets/tonal.astro';
import TonalRaw from '@/components/examples/tailwind-utilities/presets/tonal.astro?raw';
import UserGenerated from '@/components/examples/tailwind-utilities/presets/user-generated.astro';
import UserGeneratedRaw from '@/components/examples/tailwind-utilities/presets/user-generated.astro?raw';
