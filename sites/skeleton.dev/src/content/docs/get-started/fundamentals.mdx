...
Skeleton's components are built on **Zag.js**, which provides a collection of framework-agnostic UI component patterns to manage logic and state. Zag was founded and maintained by industry veterans, such as [Segun Adebayo](https://github.com/segunadebayo) - the creator and core maintainer for [Chakra UI](https://www.chakra-ui.com/).
...
You may import components frame each Skeleton framework as follows.
...
Using the extensible markup pattern, you may implement custom animations. While we showcase this with [Svelte Transitions](https://svelte.dev/docs/svelte/transition), you could also use framework agnostic solutions like [Motion](https://motion.dev/) or [Animate.css](https://animate.style/).
