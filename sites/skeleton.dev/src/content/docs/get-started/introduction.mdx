...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div className="card preset-outlined-surface-200-800 bg-surface-50-950 p-10 space-y-4">
    	...
    	<p className="text-surface-800-200">
    		We promote community-based projects that help augment Skeleton and improve your productivity, such as the <a href="https://www.etesie.dev/figma" target="_blank" rel="noopener noreferrer" class="anchor">Figma UI Kit</a>.
    	</p>
    </div>
