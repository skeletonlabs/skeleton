...
We recommend importing custom themes into the Theme Generator to automatically convert to the new format. This will also allow you to configure any new or updated features, while future-proofing the new design.
