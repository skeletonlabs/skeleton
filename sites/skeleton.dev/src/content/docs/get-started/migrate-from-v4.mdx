...
It is highly recommended that you read through the entire migration guide to verify all changes are to your preference. And of course, ensure you (or your LLM) take into account the remaining items not handled by the CLI migration. Please review the reference below.
