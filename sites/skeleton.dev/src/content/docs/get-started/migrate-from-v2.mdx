...
| `<ProgressBar>`    | [Link](https://v2.skeleton.dev/components/progress-bars)    | [Link](https://v3.skeleton.dev/docs/components/progress-linear/svelte)   | Renamed `<Progress>`                                      |
| `<ProgressRadial>` | [Link](https://v2.skeleton.dev/components/progress-radials) | [Link](https://v3.skeleton.dev/docs/components/progress-circular/svelte) | Renamed `<Progress>`                                      |
