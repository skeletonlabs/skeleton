...
<figure class="linker bg-noise">
	<a class="btn preset-filled" href="https:/.dev/docs/v5-migration-guide" target="_blank">
...
<figure class="linker bg-noise">
	<a class="btn preset-filled" href="https:/.dev/docs/kit/migrating-to-sveltekit-2" target="_blank">
...
- Changes to adopt the new [Svelte 5 APIs](https:/.dev/docs/v5-migration-guide) like runes, snippets, event handlers, etc.
...
- Changes to adopt the new [component fundamentals](/docs/get-started/fundamentals#functional-components).
...
| Name               | v2                                                          | v3                                                   | Notes                                                     |
| ------------------ | ----------------------------------------------------------- | ---------------------------------------------------- | --------------------------------------------------------- |
| `<AppRail>`        | [Link](https://v2.skeleton.dev/components/app-rail)         | [Link](/docs/framework-components/navigation)        | Renamed `<Navigation>` - greatly expanded features        |
| `<FileButton>`     | [Link](https://v2.skeleton.dev/components/file-buttons)     | [Link](/docs/framework-components/file-upload)       | Renamed `<FileUpload>` - merges `<FileDropzone>` features |
| `<FileDropzone>`   | [Link](https://v2.skeleton.dev/components/file-buttons)     | [Link](/docs/framework-components/file-upload)       | Renamed `<FileUpload>` - merges `<FileButton>` features   |
| `<InputChip>`      | [Link](https://v2.skeleton.dev/components/input-chips)      | [Link](/docs/framework-components/tags-input)        | Renamed `<TagsInput>`                                     |
| `<Paginator>`      | [Link](https://v2.skeleton.dev/components/paginators)       | [Link](/docs/framework-components/pagination)        | Renamed `<Pagination>`                                    |
| `<ProgressBar>`    | [Link](https://v2.skeleton.dev/components/progress-bars)    | [Link](/docs/framework-components/progress-linear)   | Renamed `<Progress>`                                      |
| `<ProgressRadial>` | [Link](https://v2.skeleton.dev/components/progress-radials) | [Link](/docs/framework-components/progress-circular) | Renamed `<Progress>`                                      |
| `<RadioGroup>`     | [Link](https://v2.skeleton.dev/components/radio-groups)     | [Link](/docs/framework-components/segment)           | Renamed `<SegmentedControl>`                              |
| `<RangeSlider>`    | [Link](https://v2.skeleton.dev/components/range-sliders)    | [Link](/docs/framework-components/slider)            | Renamed `<Slider>`                                        |
| `<Slider>`         | [Link](https://v2.skeleton.dev/components/slide-toggles)    | [Link](/docs/framework-components/switch)            | Renamed `<Switch>`                                        |
| `<TabGroup>`       | [Link](https://v2.skeleton.dev/components/tabs)             | [Link](/docs/framework-components/tabs)              | Renamed `<Tabs>`                                          |
...
- You are still required to implement the [Tailwind Forms Plugin](/docs/tailwind-components/forms#prerequisites) to use Skeleton form elements.
...
| Focus Trap | [Link](https://v2.skeleton.dev/actions/focus-trap) | [Link](/docs/framework-components/popover) | Built-into v4+ overlay components. |
...
| `<Autocomplete>`  | [Link](https://v2.skeleton.dev/components/autocomplete)         | [Link](/docs/framework-components/combobox)                                    | Replaced with Combobox                   |
...
| `<Table>`         | [Link](https://v2.skeleton.dev/components/tables)               | [Link](/docs/tailwind-components/tables)                                       | Removed in favor of a Tailwind component |

#### Utilities

| Name              | v2                                                             | Alternative                                     | Notes                          |
| ----------------- | -------------------------------------------------------------- | ----------------------------------------------- | ------------------------------ |
| Code Blocks       | [Link](https://v2.skeleton.dev/utilities/codeblocks)           | [Link](/docs/integrations/code-block)           | Provided via Integration guide |
| Drawers           | [Link](https://v2.skeleton.dev/utilities/drawers)              | [Link](/docs/framework-components/dialog)       | Replace with new component     |
| Modals            | [Link](https://v2.skeleton.dev/utilities/modals)               | [Link](/docs/framework-components/dialog)       | Replace with new component     |
| Popovers          | [Link](https://v2.skeleton.dev/utilities/popovers)             | [Link](/docs/framework-components/popover)      | Replace with new component     |
| Toasts            | [Link](https://v2.skeleton.dev/utilities/toasts)               | [Link](/docs/framework-components/toast)        | Replace with new component     |
