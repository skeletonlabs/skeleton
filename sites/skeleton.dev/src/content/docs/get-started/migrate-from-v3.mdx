...
As part of this update, select components have been renamed to follow [Zag.js](https://zagjs.com/) naming conventions.
...
| `<Ratings>`      | `<RatingGroup>`      | [Link](/docs/components/rating-group/svelte)      |
| `<Segment>`      | `<SegmentedControl>` | [Link](/docs/components/segmented-control/svelte) |
