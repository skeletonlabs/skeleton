...
<figure class="linker bg-noise">
	<a href={getRelativeDocsUrl(props.Astro, 'design/presets')} class="btn preset-filled">
		Browse Presets
	</a>
</figure>
...
<figure class="linker bg-noise">
	<a href={getRelativeDocsUrl(props.Astro, 'design/themes')} class="btn preset-filled">
		Browse Themes
	</a>
</figure>
