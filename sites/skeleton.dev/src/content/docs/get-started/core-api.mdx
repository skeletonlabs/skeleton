...
<figure class="linker bg-noise">
	<a href={resolve(props.Astro, '/docs/[framework]/design/presets')} class="btn preset-filled">
		Browse Presets
	</a>
</figure>
...
<figure class="linker bg-noise">
	<a href={resolve(props.Astro, '/docs/[framework]/design/themes')} class="btn preset-filled">
		Browse Themes
	</a>
</figure>
