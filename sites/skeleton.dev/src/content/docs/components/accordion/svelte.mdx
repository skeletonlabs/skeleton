...
import Columns from '@/components/examples/components/accordion/svelte/columns.svelte';
import ColumnsRaw from '@/components/examples/components/accordion/svelte/columns.svelte?raw';
