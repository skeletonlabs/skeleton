...
import Range from '@/examples/components/date-picker/react/range.tsx';
import RangeRaw from '@/examples/components/date-picker/react/range.tsx?raw';

import Inline from '@/examples/components/date-picker/react/inline.tsx';
import InlineRaw from '@/examples/components/date-picker/react/inline.tsx?raw';

import WithSelects from '@/examples/components/date-picker/react/with-selects.tsx';
import WithSelectsRaw from '@/examples/components/date-picker/react/with-selects.tsx?raw';
