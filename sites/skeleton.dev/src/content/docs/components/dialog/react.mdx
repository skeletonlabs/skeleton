...
import Default from '@/lib/components/examples/components/dialog/react/default';

import AlertDialogRaw from '@/components/examples/components/dialog/react/alert-dialog?raw';
import AlertDialog from '@/lib/components/examples/components/dialog/react/alert-dialog';

import InteractionRaw from '@/components/examples/components/dialog/react/interaction?raw';
import Interaction from '@/lib/components/examples/components/dialog/react/interaction';

import DrawerRaw from '@/components/examples/components/dialog/react/drawer?raw';
import Drawer from '@/lib/components/examples/components/dialog/react/drawer';

import ZIndexRaw from '@/components/examples/components/dialog/react/z-index?raw';
import ZIndex from '@/lib/components/examples/components/dialog/react/z-index';

import DirRaw from '@/components/examples/components/dialog/react/dir?raw';
import Dir from '@/lib/components/examples/components/dialog/react/dir';

import HeadlessRaw from '@/components/examples/components/dialog/react/headless?raw';
import Headless from '@/lib/components/examples/components/dialog/react/headless';
