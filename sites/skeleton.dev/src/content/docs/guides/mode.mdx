...
summary: Skeleton makes use of Tailwind's Dark Mode to enable multiple strategies to control the overall app or page mode, as well as Color Scheme to selectively toggle light or dark interfaces at any scope.
references:
...
<figure class="linker bg-noise">
	<a class="btn preset-filled" href={resolve(props.Astro, '/docs/[framework]/guides/cookbook/light-switch')}>
