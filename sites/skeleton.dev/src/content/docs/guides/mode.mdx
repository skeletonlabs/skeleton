...
<Summary>
	Skeleton makes use of [Tailwind's Dark Mode](https://tailwindcss.com/docs/dark-mode) to enable multiple strategies to control the overall
	app or page mode, as well as [Color Scheme](https://tailwindcss.com/docs/color-scheme) to selectively toggle light or dark interfaces at
	any scope.
</Summary>
