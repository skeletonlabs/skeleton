...
import ImgImport from '@/assets/figma/chapter-3/2-import.webp';
import ImgPublishLib from '@/assets/figma/chapter-3/3-publish-library.webp';
import ImgOpenFile from '@/assets/figma/chapter-3/4-open-file.webp';
import ImgSelectNewSkeleton from '@/assets/figma/chapter-3/4-select-new-skeleton.webp';
import ImgSelectSkeleton from '@/assets/figma/chapter-3/4-select-skeleton.webp';
import ImgRemoveOld from '@/assets/figma/chapter-3/remove-old.webp';
