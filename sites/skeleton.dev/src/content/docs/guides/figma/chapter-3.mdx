...
import import_ from '@/assets/figma/chapter-3/2-import.webp';
import publishLib from '@/assets/figma/chapter-3/3-publish-library.webp';
import openFile from '@/assets/figma/chapter-3/4-open-file.webp';
import selectNewSkeleton from '@/assets/figma/chapter-3/4-select-new-skeleton.webp';
import selectSkeleton from '@/assets/figma/chapter-3/4-select-skeleton.webp';
import removeOld from '@/assets/figma/chapter-3/remove-old.webp';
...
<Process>
    ...
    <ProcessStep step="2">
        ...
        <Image src={import_} class="rounded-container" alt="Import" />
    </ProcessStep>
    ...
    <ProcessStep step="3">
        ...
        <Image src={publishLib} class="rounded-container" alt="Publish Library" />
    </ProcessStep>
    ...
    <ProcessStep step="4">
        ...
        <Image src={openFile} class="rounded-container" alt="Open File" />

        <p className='pt-4'>Click the `Swap Library`¹² button in the bottom right corner of the popup.</p>

        <Image src={selectSkeleton} class="rounded-container" alt="Select Skeleton" />
        ...
        <Image src={selectNewSkeleton} class="rounded-container" alt="Select New Skeleton" />
...
<Image src={removeOld} class="rounded-container" alt="Remove Old Library" />
