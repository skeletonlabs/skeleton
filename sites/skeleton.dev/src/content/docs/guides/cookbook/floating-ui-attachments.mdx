...
import ExampleAttachment from '@/components/examples/guides/cookbook/floating-ui-attachments/ExampleAttachment.txt?raw';
import ExamplePopover from '@/components/examples/guides/cookbook/floating-ui-attachments/ExamplePopover.txt?raw';
import ExampleTooltip from '@/components/examples/guides/cookbook/floating-ui-attachments/ExampleTooltip.txt?raw';
