...
import ExampleSvelteRaw from '@/components/examples/guides/cookbook/light-switch/Example.svelte?raw';
import ExampleReactRaw from '@/components/examples/guides/cookbook/light-switch/Example.tsx?raw';
