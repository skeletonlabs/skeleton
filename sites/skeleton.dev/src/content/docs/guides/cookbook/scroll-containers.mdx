...
import Example from '@/lib/components/examples/guides/cookbook/scroll-containers/Example.astro';
import ExampleCarousel from '@/lib/components/examples/guides/cookbook/scroll-containers/ExampleCarousel.astro';
import ExampleMultiColumn from '@/lib/components/examples/guides/cookbook/scroll-containers/ExampleMultiColumn.astro';
