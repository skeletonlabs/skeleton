...
<Framework id="react">
	<Preview files={{ 'app/globals.css': `\`\`\`css
	@import 'tailwindcss';
...
<Framework id="react">
    <Preview files={{ 'app/global.css': `\`\`\`css
    	@import 'tailwindcss';
...
<Framework id="react">
    ...
    <Preview files={{ 'app/layout.tsx': `\`\`\`tsx
