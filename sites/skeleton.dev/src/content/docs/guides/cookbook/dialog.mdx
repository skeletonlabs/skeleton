...
import ExampleRaw from '@/components/examples/guides/cookbook/dialog/Example.astro?raw';
import Example from '@/lib/components/examples/guides/cookbook/dialog/Example.astro';
