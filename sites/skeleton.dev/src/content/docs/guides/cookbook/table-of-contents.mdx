...
import ExampleRaw from '@/components/examples/guides/cookbook/table-of-contents/Example.astro?raw';
import Example from '@/lib/components/examples/guides/cookbook/table-of-contents/Example.astro';
