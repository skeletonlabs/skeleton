...
import DefaultReact from '@/components/examples/guides/cookbook/table-of-contents/react/default';
import DefaultReactRaw from '@/components/examples/guides/cookbook/table-of-contents/react/default.tsx?raw';
import DefaultSvelte from '@/components/examples/guides/cookbook/table-of-contents/svelte/default.svelte';
import DefaultSvelteRaw from '@/components/examples/guides/cookbook/table-of-contents/svelte/default.svelte?raw';
