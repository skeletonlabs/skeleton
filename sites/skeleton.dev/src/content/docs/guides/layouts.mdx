...
import ColOne from '@/components/examples/guides/cookbook/layouts/col-one.astro';
import ColThree from '@/components/examples/guides/cookbook/layouts/col-three.astro';
import ColTwo from '@/components/examples/guides/cookbook/layouts/col-two.astro';
import StickyHeader from '@/components/examples/guides/cookbook/layouts/sticky-header.astro';
