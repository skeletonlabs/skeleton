...
summary: Skeleton supports a variety of web-based frameworks and meta-frameworks, and this guide serves as a universal reference when implementing page layouts. These techniques utilize native HTML and Tailwind, meaning Skeleton is supported but not required. The only prerequisite is Tailwind itself.
order: 50
---

import Framework from './src/components/ui/framework.astro';
import ColOneReact from '@/components/examples/guides/cookbook/layouts/react/col-one';
import ColThreeReact from '@/components/examples/guides/cookbook/layouts/react/col-three';
import ColTwoReact from '@/components/examples/guides/cookbook/layouts/react/col-two';
import StickyHeaderReact from '@/components/examples/guides/cookbook/layouts/react/sticky-header';
import ColOneSvelte from '@/components/examples/guides/cookbook/layouts/svelte/col-one.svelte';
import ColThreeSvelte from '@/components/examples/guides/cookbook/layouts/svelte/col-three.svelte';
import ColTwoSvelte from '@/components/examples/guides/cookbook/layouts/svelte/col-two.svelte';
import StickyHeaderSvelte from '@/components/examples/guides/cookbook/layouts/svelte/sticky-header.svelte';
