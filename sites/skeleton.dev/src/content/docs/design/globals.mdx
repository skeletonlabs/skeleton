...
Implements themed styled for [selection](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::selection).
...
Implements defaults and utility class for handling the [disabled](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Attributes/disabled) status for elements. Used most commonly for buttons.
