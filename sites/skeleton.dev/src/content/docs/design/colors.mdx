...
Represents the most prominant or default color when styling elements and components. Provides these benefits:
...
<Preview files={{ 'app.astro': BrandRaw }} client:visible>
	<Brand />
</Preview>
