...
<Preview files={{ 'app.astro': FilledRaw }} client:load>
	<Filled client:load />
</Preview>
...
<Preview files={{ 'app.astro': TonalRaw }} client:load>
	<Tonal client:load />
</Preview>
...
<Preview files={{ 'app.astro': OutlinedRaw }} client:load>
	<Outlined client:load />
</Preview>
...
<Preview files={{ 'app.astro': CustomRaw }} client:load>
	<Custom client:load />
</Preview>
...
<Preview files={{ 'app.astro': GradientRaw }} client:load>
	<Gradient client:load />
</Preview>

### Glass Presets

<Preview files={{ 'app.astro': GlassRaw }} client:load>
	<Glass client:load />
</Preview>
