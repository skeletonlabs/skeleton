...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': MultipleSelectionRaw }} client:visible>
...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': CollapseExpandRaw }} client:visible>
...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': LazyLoadingRaw }} client:visible>
