...
<Framework id="svelte">
	<Preview files={{ 'app.svelte': HeightSvelteRaw }} client:visible>
		<HeightSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview files={{ 'app.tsx': HeightReactRaw }} client:visible>
...
<Framework id="svelte">
	<Preview files={{ 'app.svelte': OrientationSvelteRaw }} client:visible>
		<OrientationSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview files={{ 'app.tsx': OrientationReactRaw }} client:visible>
...
<Framework id="svelte">
	<Preview files={{ 'app.svelte': IndeterminateSvelteRaw }} client:visible>
		<IndeterminateSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview files={{ 'app.tsx': IndeterminateReactRaw }} client:visible>
...
<Framework id="svelte">
	<Preview files={{ 'app.svelte': CustomAnimationSvelteRaw }} client:visible>
		<CustomAnimationSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview files={{ 'app.tsx': CustomAnimationReactRaw }} client:visible>
...
<Framework id="svelte">
	<Preview files={{ 'app.svelte': NativeSvelteRaw }} client:visible>
		<NativeSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview files={{ 'app.tsx': NativeReactRaw }} client:visible>
