...
<Framework id="react">
	<Preview framework="react" code={DefaultReactRaw} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" code={ControlledSvelteRaw} client:load>
		<ControlledSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" code={ControlledReactRaw} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" code={MultipleSvelteRaw} client:load>
		<MultipleSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" code={MultipleReactRaw} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" code={CollapsibleSvelteRaw} client:load>
		<CollapsibleSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" code={CollapsibleReactRaw} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" code={IndicatorSvelteRaw} client:load>
		<IndicatorSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" code={IndicatorReactRaw} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" code={OrientationSvelteRaw} client:load>
		<OrientationSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" code={OrientationReactRaw} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" code={DirSvelteRaw} client:load>
		<DirSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" code={DirReactRaw} client:load>
