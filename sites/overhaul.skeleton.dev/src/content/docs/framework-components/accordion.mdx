...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': DefaultSvelteRaw }} client:load>
		<DefaultSvelte client:visible />
	</Preview>
</Framework>

<Framework id="react">
	<Preview framework="react" files={{ 'app.tsx': DefaultReactRaw }} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': ControlledSvelteRaw }} client:load>
		<ControlledSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" files={{ 'app.tsx': ControlledReactRaw }} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': MultipleSvelteRaw }} client:load>
		<MultipleSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" files={{ 'app.tsx': MultipleReactRaw }} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': CollapsibleSvelteRaw }} client:load>
		<CollapsibleSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" files={{ 'app.tsx': CollapsibleReactRaw }} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': IndicatorSvelteRaw }} client:load>
		<IndicatorSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" files={{ 'app.tsx': IndicatorReactRaw }} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': OrientationSvelteRaw }} client:load>
		<OrientationSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" files={{ 'app.tsx': OrientationReactRaw }} client:load>
...
<Framework id="svelte">
	<Preview framework="svelte" files={{ 'app.svelte': DirSvelteRaw }} client:load>
		<DirSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview framework="react" files={{ 'app.tsx': DirReactRaw }} client:load>
