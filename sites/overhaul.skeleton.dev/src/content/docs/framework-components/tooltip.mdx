...
<Framework id="svelte">
	<Preview files={{ 'app.svelte': ArrowSvelteRaw }} client:visible>
		<ArrowSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview files={{ 'app.tsx': ArrowReactRaw }} client:visible>
...
<Framework id="svelte">
	<Preview files={{ 'app.svelte': ZIndexSvelteRaw }} client:visible>
		<ZIndexSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview files={{ 'app.tsx': ZIndexReactRaw }} client:visible>
...
<Framework id="svelte">
	<Preview files={{ 'app.svelte': ProgrammaticSvelteRaw }} client:visible>
		<ProgrammaticSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview files={{ 'app.tsx': ProgrammaticReactRaw }} client:visible>
...
<Framework id="svelte">
	<Preview files={{ 'app.svelte': HeadlessSvelteRaw }} client:visible>
		<HeadlessSvelte client:visible />
	</Preview>
</Framework>
<Framework id="react">
	<Preview files={{ 'app.tsx': HeadlessReactRaw }} client:visible>
