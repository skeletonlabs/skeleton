...
export async function importThemeV3Rc1(fileText: string, fileName: string) {
	...
	// Delete
	properties["--type-scale-1"] = undefined;
	properties["--type-scale-2"] = undefined;
	properties["--type-scale-3"] = undefined;
	properties["--type-scale-4"] = undefined;
	properties["--type-scale-5"] = undefined;
	properties["--type-scale-6"] = undefined;
	properties["--type-scale-7"] = undefined;
	properties["--type-scale-8"] = undefined;
	properties["--type-scale-9"] = undefined;
	properties["--type-scale-10"] = undefined;
	properties["--type-scale-11"] = undefined;
	properties["--type-scale-12"] = undefined;
	properties["--type-scale-13"] = undefined;
	// ---
	properties["--space-scale-factor"] = undefined;
	properties["--type-scale-factor"] = undefined;
	properties["--radii-default"] = undefined;
	properties["--radii-container"] = undefined;
	properties["--border-width-default"] = undefined;
	properties["--divide-width-default"] = undefined;
	properties["--ring-width-default"] = undefined;
	properties["--outline-width-default"] = undefined;

	// Colors (rgb -> oklch)
	for (const key in properties) {
		if (key.includes("--color") && !properties[key].includes("var(")) {
			properties[key] = chroma(
				`rgb(${properties[key].replaceAll(" ", ", ")})`,
			).hex();
		}
	}
