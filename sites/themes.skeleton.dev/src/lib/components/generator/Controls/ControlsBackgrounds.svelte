...
<div class="space-y-4">
	...
	<label class="label space-y-2">
		...
		<div class="border-surface-200-800 rounded-base h-8 w-full border" style:background="var(--body-background-color)"></div>
	...
	<label class="label space-y-2">
		...
		<div class="border-surface-200-800 rounded-base h-8 w-full border" style:background="var(--body-background-color-dark)"></div>
