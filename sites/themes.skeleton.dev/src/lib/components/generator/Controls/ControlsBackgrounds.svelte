...
<div class="space-y-4">
  ...
  <label class="label space-y-2">
    ...
    <div
      class="w-full h-8 border border-surface-200-800 rounded-base"
      style:background={"var(--body-background-color)"}
    ></div>
    <select
      class="select"
      name="--body-background-color"
      bind:value={settingsBackgrounds["--body-background-color"]}
    >
  ...
  <label class="label space-y-2">
    ...
    <div
      class="w-full h-8 border border-surface-200-800 rounded-base"
      style:background={"var(--body-background-color-dark)"}
    ></div>
    <select
      class="select"
      name="--body-background-color-dark"
      bind:value={settingsBackgrounds["--body-background-color-dark"]}
    >
