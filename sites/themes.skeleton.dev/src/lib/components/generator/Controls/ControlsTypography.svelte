...
// Local
const category: "base" | "headings" | "anchors" = $state("base");
</script>
...
<div class="space-y-4">
  ...
  <div class="label">
    <div class="flex justify-between gap-4">
      ...
      <a
        class="text-inherit underline label-text"
    ...
    >
      {#each constants.typographicScales as typographicScale}
        <button
          type="button"
          onclick={() =>
            (settingsTypography["--text-scaling"] = typographicScale.value)}
          class="flex flex-col items-center py-2 {settingsTypography[
            '--text-scaling'
          ] === typographicScale.value
            ? 'preset-filled'
            : 'hover:preset-tonal-primary'}"
        >
          <strong class="text-[16px]">{typographicScale.value}</strong>
          <strong class="text-[10px] opacity-50"
            >{typographicScale.label}</strong
          >
        </button>
      {/each}
    </div>
  ...
  <Tabs
    value={category}
    onValueChange={(e) => (category = e.value as typeof category)}
    fluid
  >
    {#snippet list()}
    ...
    {#snippet content()}
      <p class="mb-5 opacity-60">
        {#if category === "base"}Set global defaults for text colors and font
          styles.{/if}
        {#if category === "headings"}Adjust headings (H1-H6) text color and font
          styles.{/if}
        {#if category === "anchors"}Adjust anchor link text color and font
          styles.{/if}
      </p>
      <!-- Panel: Base -->
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <label class="label space-y-2">
            ...
            <select
              ...
              bind:value={settingsTypography["--base-font-color"]}
            >
          ...
          <label class="label space-y-2">
            ...
            <select
              class="select"
              name="--base-font-color-dark"
              bind:value={settingsTypography["--base-font-color-dark"]}
            >
          ...
          <label class="label col-span-2">
            ...
            <select
              ...
              bind:value={settingsTypography["--base-font-family"]}
            >
          ...
          <label class="label">
            ...
            <select
              class="select"
              name="--base-font-size"
              bind:value={settingsTypography["--base-font-size"]}
            >
          ...
          <label class="label">
            ...
            <select
              ...
              bind:value={settingsTypography["--base-line-height"]}
            >
          ...
          <label class="label">
            ...
            <select
              ...
              bind:value={settingsTypography["--base-font-weight"]}
            >
          ...
          <label class="label">
            ...
            <select
              class="select"
              name="--base-font-style"
              bind:value={settingsTypography["--base-font-style"]}
            >
          ...
          <label class="label">
            ...
            <select
              class="select"
              name="--base-letter-spacing"
              bind:value={settingsTypography["--base-letter-spacing"]}
            >
      ...
      <Tabs.Panel value="headings">
        <div class="grid grid-cols-2 gap-4">
          ...
          <label class="label space-y-2">
            ...
            <div
              class="w-full h-4 border border-surface-200-800 rounded-base"
              style:background={settingsTypography["--heading-font-color"] ===
              "inherit"
            ...
            <select
              ...
              bind:value={settingsTypography["--heading-font-color"]}
            >
          ...
          <label class="label space-y-2">
            ...
            <div
              class="w-full h-4 border border-surface-200-800 rounded-base"
              style:background={settingsTypography[
                "--heading-font-color-dark"
              ] === "inherit"
            ...
            <select
              class="select"
              name="--heading-font-color-dark"
              bind:value={settingsTypography["--heading-font-color-dark"]}
            >
              <option value="inherit">inherit</option>
              <option value="255 255 255">White</option>
              {#each constants.colorNames as colorName}
          ...
          <label class="label col-span-2">
            ...
            <select
              ...
              bind:value={settingsTypography["--heading-font-family"]}
            >
              = {#each constants.fontFamilies as fontFamily}
                <option value={fontFamily}>{fontFamily}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              ...
              bind:value={settingsTypography["--heading-font-weight"]}
            >
              {#each constants.fontWeights as fontWeight}
                <option value={fontWeight}>{fontWeight}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              ...
              bind:value={settingsTypography["--heading-font-style"]}
            >
              {#each constants.fontStyles as fontStyle}
                <option value={fontStyle}>{fontStyle}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              ...
              bind:value={settingsTypography["--heading-letter-spacing"]}
            >
              {#each constants.letterSpacings as letterSpacing}
                <option value={letterSpacing}>{letterSpacing}</option>
              {/each}
      ...
      <Tabs.Panel value="anchors">
        <div class="grid grid-cols-2 gap-4">
          ...
          <label class="label space-y-2">
            ...
            <div
              class="w-full h-4 border border-surface-200-800 rounded-base"
              style:background={settingsTypography["--anchor-font-color"] ===
              "inherit"
                ? `${settingsTypography["--base-font-color"]}`
            ...
            <select
              class="select"
              name="--anchor-font-color"
              bind:value={settingsTypography["--anchor-font-color"]}
            >
              <option value="inherit">inherit</option>
              {#each constants.colorNames as colorName}
                <optgroup label={colorName}>
          ...
          <label class="label space-y-2">
            ...
            <select
              class="select"
              name="--anchor-font-color-dark"
              bind:value={settingsTypography["--anchor-font-color-dark"]}
            >
              <option value="inherit">inherit</option>
              {#each constants.colorNames as colorName}
                <optgroup label={colorName}>
          ...
          <label class="label col-span-2">
            ...
            <select
              ...
              bind:value={settingsTypography["--anchor-font-family"]}
            >
              = {#each constants.fontFamilies as fontFamily}
                <option value={fontFamily}>{fontFamily}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              ...
              bind:value={settingsTypography["--anchor-font-size"]}
            >
              {#each constants.fontSizes as fontSize}
                <option value={fontSize}>{fontSize}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              class="select"
              name="--anchor-line-height"
              bind:value={settingsTypography["--anchor-line-height"]}
            >
              {#each constants.lineHeights as lineHeight}
                <option value={lineHeight}>{lineHeight}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              ...
              bind:value={settingsTypography["--anchor-font-weight"]}
            >
              {#each constants.fontWeights as fontWeight}
                <option value={fontWeight}>{fontWeight}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              class="select"
              name="--anchor-font-style"
              bind:value={settingsTypography["--anchor-font-style"]}
            >
              {#each constants.fontStyles as fontStyle}
                <option value={fontStyle}>{fontStyle}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              class="select"
              name="--anchor-letter-spacing"
              bind:value={settingsTypography["--anchor-letter-spacing"]}
            >
              {#each constants.letterSpacings as letterSpacing}
                <option value={letterSpacing}>{letterSpacing}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              ...
              bind:value={settingsTypography["--anchor-text-decoration"]}
            >
          ...
          <label class="label">
            ...
            <select
              ...
              bind:value={settingsTypography["--anchor-text-decoration-hover"]}
            >
              {#each constants.textDecorations as textDecoration}
                <option value={textDecoration}>{textDecoration}</option>
              {/each}
          ...
          <label class="label">
            ...
            <select
              class="select"
              name="--anchor-text-decoration-focus"
              bind:value={settingsTypography["--anchor-text-decoration-focus"]}
            >
              {#each constants.textDecorations as textDecoration}
                <option value={textDecoration}>{textDecoration}</option>
              {/each}
