...
<div
  class="lg:hidden absolute top-0 z-50 left-0 w-full h-full bg-surface-50-950 flex justify-center items-center p-4"
>
  <div class="card bg-surface-100-900 max-w-96 p-10 space-y-5 shadow-xl">
    <Logo />
    <h2 class="h2">Not Available.</h2>
    <p class="opacity-60">
      The theme generator is not currently available for small screen devices.
      We recommend using either a tablet or desktop.
    </p>
  </div>
</div>
