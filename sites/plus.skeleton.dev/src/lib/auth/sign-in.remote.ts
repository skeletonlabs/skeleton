...
// @ts-expect-error variables are only present in the preview/production environment
import { VERCEL_URL, VERCEL_PROJECT_PRODUCTION_URL } from '$env/dynamic/private';
