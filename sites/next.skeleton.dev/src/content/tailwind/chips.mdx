...
import Example from "@examples/tailwind/chips/Example.svelte";
import ExampleRaw from "@examples/tailwind/chips/Example.svelte?raw";
...
<Preview client:load>
    ...
    <Fragment slot="code">
        ...
        <Code code={ExampleRaw} lang="ts" title="demo.svelte" class="mt-4" />
    </Fragment>
</Preview>