...
<figure class="card-enhanced-gradient p-8 flex justify-center">
	<a href="https://themes.skeleton.dev/" target="_blank" class="btn preset-filled">Theme Generator &rarr;</a>
</figure>
...
6. Create a new file in the root of your project called `theme-custom.ts` (any name is fine).
