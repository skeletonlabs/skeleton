...
<p class="type-scale-5">Skeleton is powered by a fully featured [Tailwind Plugin](https://tailwindcss.com/docs/plugins). This adapts and extends Tailwind to handle Skeleton's base styles, color system, typography, and more. The following API details all available Skeleton utility classes and the theme-specific CSS custom properties.</p>
