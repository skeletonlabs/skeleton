...
This application implements the React version of [Lucide](https://lucide.dev/) to display icons. View <a href="/docs/design/iconography" class="anchor">Iconography</a> for details.
