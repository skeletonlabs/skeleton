...
Allows you to [generate a visual aid](/docs/components/accordion/react#anatomy) that showcases how a component's template was contructed, how we label each part of the component, and how those labels are used for style prop prefixes.
...
* `isRow` - applies styles to ensure child elements align as a horizontal row.
