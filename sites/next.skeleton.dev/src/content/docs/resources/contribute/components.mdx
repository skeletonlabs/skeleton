...
| Directory                   | Framework/Library             |
| --------------------------- | ----------------------------- |
| `/packages/skeleton-svelte` | [Svelte](https://svelte.dev/) |
| `/packages/skeleton-react`  | [React](https://react.dev/)   |

## Playgrounds

| Directory                      | Framework/Library             | App Framework                            |
| ------------------------------ | ----------------------------- | ---------------------------------------- |
| `/playgrounds/skeleton-svelte` | [Svelte](https://svelte.dev/) | [SvelteKit](https://svelte.dev/docs/kit) |
| `/playgrounds/skeleton-react`  | [React](https://react.dev/)   | [NextJS](https://nextjs.org/)            |
