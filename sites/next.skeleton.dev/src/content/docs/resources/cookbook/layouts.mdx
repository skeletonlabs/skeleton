...
<Preview client:load>
	...
	<Fragment slot="code">
		...
		<figure class="card-enhanced-gradient flex justify-center p-8">
			<a
				class="btn preset-filled"
				href="https://play.tailwindcss.com/F3hNZqs15v"
				target="_blank"
			>
				View on Tailwind Play &rarr;
			</a>
...
For `<aside>`, we'll use these same three utlity classes, with two extra additions:
...
> NOTE: due to the use of `h-screen` we've skipped the embedded preview in favor of the live example.
