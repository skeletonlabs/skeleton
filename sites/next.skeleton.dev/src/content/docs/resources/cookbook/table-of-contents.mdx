...
showDocsUrl: true
pubDate: 2024-11-19
tags: ['presentation', 'navigation', 'guides']
---

export const components = componentSet;

import Example from '@examples/resources/cookbook/table-of-contents/Example.astro';
import ExampleRaw from '@examples/resources/cookbook/table-of-contents/Example.astro?raw';
