...
<figure class="linker">
	<a href="/docs/tailwind/badges" class="linker-item">
		Browse Components
	</a>
</figure>
...
<figure class="linker">
	<a href="/docs/design/spacing" class="linker-item">
		Browse Spacing
	</a>
</figure>
...
<figure class="linker">
	<a href="/docs/design/colors#color-pairings" class="linker-item">
...
<figure class="linker">
	<a href="/docs/design/presets" class="linker-item">
		Browse Presets
	</a>
</figure>
...
<figure class="linker">
	<a href="/docs/design/typography" class="linker-item">
		Browse Typography
	</a>
</figure>
