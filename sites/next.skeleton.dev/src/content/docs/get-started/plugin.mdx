...
<p class="type-scale-5">
	Skeleton is powered by a fully featured [Tailwind Plugin](https://tailwindcss.com/docs/plugins). This adapts and
	extends Tailwind to handle Skeleton's base styles, color system, typography, and more. The following API details all
	available Skeleton utility classes and the theme-specific CSS custom properties.
</p>
...
<figure class="card-enhanced-gradient p-8 flex justify-center">
	<a href="/tailwind/badges" class="btn preset-filled">
...
<figure class="card-enhanced-gradient p-8 flex justify-center">
	<a href="/design/spacing" class="btn preset-filled">
		Browse Spacing &rarr;
	</a>
</figure>
...
<figure class="card-enhanced-gradient p-8 flex justify-center">
	<a href="/design/colors#pairings" class="btn preset-filled">
...
<figure class="card-enhanced-gradient p-8 flex justify-center">
	<a href="/design/presets" class="btn preset-filled">
		Browse Presets &rarr;
	</a>
</figure>
