...
<figure class="card-filled-enhanced flex justify-center p-8">
	<a href="/docs/design/colors#color-pairings" class="btn preset-filled">
...
<figure class="card-filled-enhanced flex justify-center p-8">
	<a href="/docs/design/typography" class="btn preset-filled">
		Browse Typography &rarr;
	</a>
</figure>

#### Type Scale

Implements a [typographic scale](https://designcode.io/typographic-scales) using the following formula. `--type-scale-factor` is defined in your theme.
