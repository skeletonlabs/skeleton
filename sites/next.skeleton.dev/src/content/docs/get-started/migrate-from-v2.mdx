...
<div className="card preset-outlined-error-500 preset-tonal-error space-y-8 p-8">
	<p>
...
<div class="card preset-outlined-warning-500 preset-tonal-warning space-y-8 p-8">
	<p>
