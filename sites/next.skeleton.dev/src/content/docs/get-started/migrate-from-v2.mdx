...
2. Remove the `purgecss` (`vite-plugin-tailwind-purgecss`) vite plugin from your `vite.config` (You might or might not have this installed, if not, you can ignore this step).
