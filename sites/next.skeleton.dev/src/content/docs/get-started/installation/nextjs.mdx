    ...
    <ProcessStep step="1">
		...
		*/}
		...
		<div class="card preset-outlined-warning-500 p-8 space-y-8">
			<p>NOTE: The Next.js CLI does not yet install <u>Tailwind v4</u>. Please follow the [official Tailwind guide](https://tailwindcss.com/docs/installation/framework-guides/nextjs).</p>
		</div>
    </ProcessStep>
    <ProcessStep step="2">
        ### Install Skeleton
