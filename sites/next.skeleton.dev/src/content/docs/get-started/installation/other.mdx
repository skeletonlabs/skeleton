...
The core of Skeleton is our [Tailwind Plugin](/docs/get-started/plugin), which provides access to our framework agnostic [design system](/docs/get-started/fundamentals#design-system) and [Tailwind-based](/docs/get-started/fundamentals#tailwind) features - everything *except* components. This comes with two prerequisites:
...
While we officially limit support for Skeleton to React, Svelte, and Astro frameworks for now, we have a thriving community of users on [GitHub](https://github.com/skeletonlabs/skeleton/discussions) and [Discord](https://discord.gg/EXqV7W8MtY). If you need further support (directly related to Skeleton) considering reaching out. Other members of the community may be able to assist you.
