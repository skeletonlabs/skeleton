...
import ImgHero from '@images/get-started/figma/hero.png';
import ImgComponents from '@images/get-started/figma/components.png';
import ImgPlugin from '@images/get-started/figma/plugin.png';
import ImgTutorial from '@images/get-started/figma/tutorials.png';
