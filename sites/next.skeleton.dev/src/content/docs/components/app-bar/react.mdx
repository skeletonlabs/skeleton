...
<Anatomy label="AppBar" isComponent>
	<Anatomy label="AppBar.Toolbar" isComponent>
		<Anatomy label="AppBar.ToolbarLead" isComponent />
		<Anatomy label="AppBar.ToolbarCenter" isComponent />
		<Anatomy label="AppBar.ToolbarTrail" isComponent />
	</Anatomy>
	<Anatomy label="AppBar.Headline" isComponent />
</Anatomy>
