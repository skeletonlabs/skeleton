...
import NavigationDocs from '@component-docs/svelte/Navigation.json';
...
<ApiTable types={['NavCommonProps', 'NavBarProps', 'NavRailProps', 'NavTileProps']} schema={NavigationDocs} />
