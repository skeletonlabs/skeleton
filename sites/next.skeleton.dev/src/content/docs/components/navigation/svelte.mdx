...
<Anatomy label="Navigation.Rail" element="aside" isComponent>
	<Anatomy label="header" />
	<Anatomy label="tiles">
		<Anatomy label="Navigation.Tile" element="a|button" isComponent>
...
<Anatomy label="Navigation.Bar" element="aside" isComponent>
	<Anatomy label="tiles">
		<Anatomy label="Navigation.Tile" element="a|button" isComponent>
			<Anatomy label="expanded">
				<Anatomy label="label|labelExpanded" />
