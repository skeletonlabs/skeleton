...
<Anatomy label="FileUpload" isComponent>
	...
	<Anatomy label="fileList" element="ul">
		<Anatomy label="file" element="li">
			<Anatomy label="fileName" element="p" />
			<Anatomy label="fileSize" element="p" />
			<Anatomy label="fileButton" element="button" />
		</Anatomy>
	</Anatomy>
</Anatomy>
