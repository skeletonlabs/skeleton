...
Skeleton themes also include contrast color values for every shade. These are defined via each respective [theme property](/docs/get-started/plugin#colors).

```
[style]-[color]-contrast-[shade]
```
...
Color Pairings are dedicated utility classes that provide an opinionated pair of color for light and dark mode.
...
See the [Preset system](/docs/design/presets) for canned utlity classes that automatically mix contrast and color pairings.
