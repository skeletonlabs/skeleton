...
When working with designers, they may supply a number of semantic typography elements. To handle this, recommend implementing [custom presets](/docs/design/presets#custom-presets) that mix Skeleton and Tailwind primitives to replicate these styles. These can be added directly to your global stylesheet.
The class names and styles shown below are merely a suggestion.
