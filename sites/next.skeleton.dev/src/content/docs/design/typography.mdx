...
Typography can differ wildly from project to project, so we advise abstracting your own set of semantic typographic classes. These can be generated using any combination of Skeleton and Tailwind primitives. Consider using a standardized prefix, such as `type-*` for each of these.
