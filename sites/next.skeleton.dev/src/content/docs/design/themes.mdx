...
<p class="type-scale-5">
	Themes are the heart of the Skeleton's design system, empowered by [CSS custom
	properties](https://developer.mozilla.org/en-US/docs/Web/CSS/--*), authored as CSS-in-JS to enable simple
	integration into Skeleton's Tailwind plugin. Which allows for simple pre-registration and switching on demand.
</p>
...
For more information, please refer to the full [Tailwind Plugin documentation](/docs/plugin).
