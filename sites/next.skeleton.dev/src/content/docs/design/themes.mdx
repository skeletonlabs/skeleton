...
Additionally you can modify these directly with CSS by targetting the `<body>` element.
...
Skeleton recommends the use of [Fontsource](https://fontsource.org/) for installing and managing custom.
