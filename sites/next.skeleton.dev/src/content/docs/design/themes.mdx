...
If you wish to update the CSS Custom Properties provided by any of Skeleton's preset themes. Apply the following changes in your global stylesheet. This will target the root scope, a specific theme, then modify each [theme property](/docs/get-started/core-api) value.
...
Your app's background colors are set automatically using two specific [theme properties](/docs/get-started/core-api#colors). Overwrite these using your global stylesheet.
...
Finally, overwrite each applicable [theme property](/docs/get-started/core-api#base-1) for your target theme.
...
For more information, please refer to the full [Tailwind Plugin documentation](/docs/get-started/core-api).
