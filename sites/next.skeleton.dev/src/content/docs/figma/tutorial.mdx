...
<div class="flex flex-col items-center gap-4">
  <div class="flex flex-col items-center">
    ...
    Congratulations! You've set-up the Figma Design-System in your project.
  </div>
  <div class="border-2 p-6 rounded-container flex flex-col items-center gap-4">
  Next Up

  Chapter 2: Set-up your own Theme
  
  <a class="btn preset-filled-primary-500" href="">Start Chapter 2 <ArrowRight /></a>
  </div>
</div>
