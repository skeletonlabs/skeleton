...
description: Learn how to set up and use the Skeleton Figma Design System.
order: 0
---
...
<Process>
    ...
    <ProcessStep step="2">
        ...
        In the left sidebar, click `Assets`³, then click the `Book` icon⁴. A modal will appear with the `Libraries` tab active. Search for `skeleton`⁵ and click `Add to file`⁶.
