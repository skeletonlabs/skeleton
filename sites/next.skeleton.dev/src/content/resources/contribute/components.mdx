...
In some scenarios you may need to conditionally update or swap between one or more sets of utilty classes. For this, we will use an “interceptor” pattern as demonstrated below. The `rx` naming convention denotes when the value is “reactive”.
