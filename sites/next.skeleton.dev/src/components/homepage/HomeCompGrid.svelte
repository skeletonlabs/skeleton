...
// Classes
const cardClasses =
	"card preset-outlined-surface-200-800 bg-surface-50-950 p-5 space-y-5";
  ...
  <div class="grid grid-cols-4 gap-4">
    ...
    <div class={`${cardClasses}`}>
      ...
      <nav class="grid grid-cols-2 gap-5">
        <button class="btn preset-outlined-surface-200-800 hover:preset-tonal"
          >GitHub</button
        >
        <button class="btn preset-outlined-surface-200-800 hover:preset-tonal"
          >Google</button
    ...
    <div class={`${cardClasses}`}>
      ...
      <section class="w-full space-y-5">
        <div class="flex justify-between items-center gap-4">
          ...
          <Switch
            name="disturb"
            checked={notifications.disturb}
            onCheckedChange={(e) => (notifications.disturb = e.checked)}
          ></Switch>
        </div>
        <hr class="hr" />
        <div class="flex justify-between items-center gap-4">
    ...
    <div class={`${cardClasses} row-span-2`}>
      <div class="space-y-4">
        <header>
          <h2 class="h4">Team</h2>
          <p class="opacity-60">
            View all members of the team, or filter using the search field
            provided.
          </p>
        </header>
        ...
        <div class="grid grid-cols-1 gap-2">
          {#each teamData as member, i}
            ...
            <button
              type="button"
              class="card w-full grid grid-cols-[auto_1fr] items-center gap-4 p-3"
            >
              <Avatar
    ...
    <div class={`${cardClasses} row-span-2`}>
      ...
      <div class="grid grid-cols-4 gap-2 items-center">
        ...
        >
          <div
            class="w-8 aspect-square rounded-full flex justify-center items-center preset-filled-primary-500"
          >
    ...
    <div class={`${cardClasses} row-span-2`}>
      ...
      <hr class="hr" />
      <p class="opacity-60">
        Data represents quarterly metrics for the TPS reports. Updates every 24
        hours.
      </p>
    </div>
    <!-- 7 -->
    ...
    <div class={`${cardClasses} row-span-2 row-start-5 text-center`}>
      <button
        type="button"
        class="w-16 aspect-square preset-tonal-success flex justify-center items-center mx-auto rounded-full"
      >
    ...
    <div class={`${cardClasses} row-span-2 col-start-2 row-start-6 row-end-9`}>
      ...
      <label class="label">
        ...
        <nav
          class="btn-group preset-outlined-surface-200-800 grid grid-cols-3 gap-2 p-2"
        >
    ...
    <div class={`${cardClasses} row-span-2 row-start-7`}>
      <div class="space-y-2">
        ...
        <p class="text-xs opacity-60">
          <span class="badge preset-tonal">+150% increase</span>
        </p>
      </div>
    </div>
    <!-- 14 -->
    <div class={`${cardClasses} col-span-2 row-span-2 col-start-3 row-start-7`}>
      <div
        class="h-full grid grid-cols-[auto_2fr_0.5fr] items-center gap-2 px-5"
      >
        <button
          type="button"
        ...
        <div class="grid grid-cols-[auto_1fr_auto] gap-5 items-center px-10">
          <button type="button" class="btn hover:preset-tonal"
            ><IconRewind class="size-4 opacity-60" /></button
          >
          <div class="space-y-1">
          ...
          <button type="button" class="btn hover:preset-tonal"
            ><IconFastForward class="size-4 opacity-60" /></button
          >
        </div>
        <div class="grid grid-cols-[auto_1fr] gap-2 items-center">
