...
const modeState = $state(false); // false = dark mode
...
<ToastProvider>
  <div class="grid h-screen grid-cols-[320px_minmax(0,_1fr)]">
    ...
    <div class="bg-surface-100-900 space-y-8 overflow-y-auto p-8">
      <a
        class="text-sm bg-orange-500 p-2 font-mono font-bold text-white"
        href="/">skeleton-svelte</a
      >
      <hr class="hr" />
      <Switch
        name="mode"
      ...
      <div class="space-y-8">
        ...
        <nav class="text-sm flex flex-col gap-2">
          ...
          <a class="anchor" href="/components/segment-control"
            >Segment Control</a
          >
