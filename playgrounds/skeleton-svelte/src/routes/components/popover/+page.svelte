...
<div class="space-y-10">
  ...
  <section class="grid grid-cols-[1fr_auto] items-center gap-4">
    ...
    <button class="btn preset-filled" onclick={popoverOpen} disabled={openState}
      >Open Popover</button
    >
  </section>
  <section
    class="border border-surface-200-800 space-y-4 p-20 flex justify-center items-center"
  >
    <Popover
      open={openState}
      ...
      {#snippet content()}
        ...
        <article>
          <p class="opacity-60">
            ...
            odio maxime placeat quia eligendi distinctio.
          </p>
        </article>
      {/snippet}
    </Popover>
