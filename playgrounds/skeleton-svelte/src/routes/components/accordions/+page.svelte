...
const valueDefault = $state(["club"]);
const valueMultiple = $state(["club"]);
const valueCollapsible = $state(["club"]);
...
<div class="space-y-10">
  ...
  <section class="space-y-4">
    ...
    <Accordion
      value={valueDefault}
      onValueChange={(e) => (valueDefault = e.value)}
    >
  ...
  <section class="space-y-4">
    ...
    <Accordion
      value={valueCollapsible}
      onValueChange={(e) => (valueCollapsible = e.value)}
      collapsible
    >
      {#each exampleItems as item, i}
        <Accordion.Item value={item.value}>
  ...
  <section class="space-y-4">
    ...
    <Accordion
      value={valueMultiple}
      onValueChange={(e) => (valueMultiple = e.value)}
      multiple
    >
      {#each exampleItems as item, i}
        <Accordion.Item value={item.value}>
