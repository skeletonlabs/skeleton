...
function triggerError() {
	toast.create({
		title: "Error",
		description:
			"Error: Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, pariatur distinctio beatae.",
		type: "error",
	});
}
...
<div class="space-y-10">
  ...
  <section class="space-y-4">
    <div class="flex gap-4">
      ...
      >
      <button class="btn preset-tonal" onclick={triggerError}
        >Toast: Error</button
      >
