		...
		<div className="space-y-10">
			...
			<section className="space-y-4">
				...
				<Accordion
					...
					onValueChange={(e) => setValueCollapsible(e.value)}
					collapsible
				>
					{exampleItems.map((item, i) => (
						<div className="flex flex-col gap-2" key={item.value}>
			...
			<section className="space-y-4">
				...
				<Accordion
					value={valueMultiple}
					onValueChange={(e) => setValueMultiple(e.value)}
					multiple
				>
					{exampleItems.map((item, i) => (
						<div className="flex flex-col gap-2" key={item.value}>
